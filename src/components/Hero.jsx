...
const Hero = () => {
  return (
    ...
    >
      {/* Decorative leaf icons — hidden on mobile */}
      <span className="hidden md:block absolute top-8 left-200 text-[#4a7a3a] text-3xl opacity-60 select-none">🪴</span>
      <span className="hidden md:block absolute top-20 right-20 text-[#4a7a3a] text-4xl opacity-50 select-none rotate-12">🌿</span>
      <span className="hidden md:block absolute bottom-24 left-[55%] text-[#4a7a3a] text-4xl opacity-50 select-none -rotate-12">🌱</span>
      <span className="hidden md:block absolute bottom-24 left-80 text-[#4a7a3a] text-4xl opacity-50 select-none rotate-12">🌾</span>

      <div className="w-full max-w-7xl mx-auto px-6 md:px-20 flex flex-col md:flex-row items-center md:justify-between gap-8 md:gap-10 py-12 md:py-0 md:-mt-16">
        ...
        <div className="flex-1 flex justify-center items-end z-10">
          <img
            src={plant}
            alt="Plant"
            className="w-2/3 md:w-full max-w-xl object-contain drop-shadow-2xl"
          />
        </div>
      </div>
    </section>
